...
import { LLMApiError, type GenerateParams, type GenerateTextResult, type LanguageModel, type Message, type Provider, type ToolCall } from "../type"
  ...
  return (modelId: string): LanguageModel => ({
    async doGenerate(params: GenerateParams): Promise<GenerateTextResult> {
      ...
      try {
        ...
        if (!choice) {
          throw new LLMApiError(500, "openai", "no_response", "APIからの応答がありません")
        }
